...
INSERT INTO Product (id, branch_id, name, interest_rate, effective_date, period, tax_rate, registrant_id, account_type,
                     product_type, interest_calculation_method)
VALUES (product_seq.NEXTVAL, 1, '다달이더한자유적금', 4.5, SYSDATE, '06',
...
INSERT INTO Account(id, branch_id, customer_id, product_id, registrant_id, start_date, preferential_interest_rate,
                    expire_date, password, balance, account_type, open_date, status,
                    version)
VALUES ('001-0000073-7373', 1, 2, 14, 2, TO_TIMESTAMP('2024-02-02 00:00:00', 'YYYY-MM-DD HH24:MI:SS'),
    0.1, TO_TIMESTAMP('2024-08-02 00:00:00', 'YYYY-MM-DD HH24:MI:SS'),
    '$2a$12$KEC0twTfMAlrbchL4p4lPOyX7/n0Q/eNZjsLkA0yY5j.udeV6MiO6',
    120000, 'PRIVATE', TO_TIMESTAMP('2024-02-02 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'OPN', 1);
...
VALUES (Interest_seq.nextval, '001-0000073-7373', 1, 1,
        ...
        462, 120000, 4.5, 0.1,'N', 1);

-- 5 이자 내역
INSERT INTO Interest (id, acc_id, registrant_id, branch_id, creation_date, amount, balance, interest_rate,
                      preferential_interest_rate, payment_status, version)
VALUES (Interest_seq.nextval, '001-0000073-7373', 1, 1,
        TO_TIMESTAMP('2024-05-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        464, 120000, 4.5, 0.1,'N', 1);

-- 6 이자 내역
INSERT INTO Interest (id, acc_id, registrant_id, branch_id, creation_date, amount, balance, interest_rate,
                      preferential_interest_rate, payment_status, version)
VALUES (Interest_seq.nextval, '001-0000073-7373', 1, 1,
        TO_TIMESTAMP('2024-06-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        465, 120000, 4.5, 0.1,'N', 1);
...
VALUES (Interest_seq.nextval, '001-0000073-7373', 1, 1,
        ...
        467, 120000, 4.5, 0.1,'N', 1);

-- 8 이자 내역
INSERT INTO Interest (id, acc_id, registrant_id, branch_id, creation_date, amount, balance, interest_rate,
                      preferential_interest_rate, payment_status, version)
VALUES (Interest_seq.nextval, '001-0000073-7373', 1, 1,
        TO_TIMESTAMP('2024-08-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'),
        469, 120000, 4.5, 0.1,'N', 1);
