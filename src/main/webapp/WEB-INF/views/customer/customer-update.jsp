...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/page/customer-update.css" />
...
<div id="main-area">
    ...
    <div>
        ...
        <div class="d-flex align-items-center">
            <input style="width:30%;" type="text" id="customer-id-text" placeholder="고객 번호를 입력하세요">
            <button id="customer-search-btn" type="button" class="basic-btn" style="display: flex; align-items: center; justify-content: center">
    ...
    <div class="d-flex justify-content-end mt-4 mb-4">
        <button class="basic-btn" id="customer-update-btn">수정사항 저장</button>
    </div>
...
<script src="/resources/js/page/customer-update.js"></script>
