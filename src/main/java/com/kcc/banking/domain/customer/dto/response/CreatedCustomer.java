...
public class CreatedCustomer {
    ...
    @Builder
    public CreatedCustomer(Long id, String branchName, String registrantName, Timestamp currentBusinessDate, Timestamp birthDate, String name, String phoneNumber, String address, String gender, String detailAddress, String identificationCode, String email, String securityLevel) {
        this.id = id;
